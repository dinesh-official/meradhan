...
import { T_SESSION_LOGS_MERADHAN_RESPONSE } from "@root/apiGateway";
...
interface SessionLogsMeradhanTableProps {
  ...
  isLoading: boolean;
  meta?: T_SESSION_LOGS_MERADHAN_RESPONSE["responseData"]["meta"];
...
const getSessionStatus = (
  session: T_SESSION_LOGS_MERADHAN_RESPONSE["responseData"]["data"][number]
) => {
  const now = new Date();
...
const SessionLogsMeradhanTable = ({
  data,
  isLoading,
  meta,
  onPageChange,
...
export default SessionLogsMeradhanTable;
