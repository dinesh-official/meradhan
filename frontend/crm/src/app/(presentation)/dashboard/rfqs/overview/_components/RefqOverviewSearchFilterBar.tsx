...
interface RefqOverviewSearchFilterBarProps {
  searchValue?: string;
  ...
  bondTypeOptions?: SelectOption[];
  exchangesOptions?: SelectOption[];
  placeholder?: string;
}
...
const filterExchangeOptions: SelectOption[] = [
  { label: "All Exchanges", value: "ALL" },
  { label: "NSE", value: "NSE" },
  { label: "BSE", value: "BSE" },
];

const RefqOverviewSearchFilterBar: React.FC<
  RefqOverviewSearchFilterBarProps
> = ({
  searchValue,
  onSearchChange,
  statusValue,
  ...
  bondTypeOptions = filterBondType,
  exchangesOptions = filterExchangeOptions,
  placeholder = "Search...",
}) => {
  return (
    <CardHeader>
...
export default RefqOverviewSearchFilterBar;
