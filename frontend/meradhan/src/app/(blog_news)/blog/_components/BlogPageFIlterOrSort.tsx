...
import { T_BLOGS_GQL_RESPONSE } from "../_gql/blogs.gql";
function BlogPageFIlterOrSort({
  category,
  sort,
  categoryName,
}: {
  category: T_BLOGS_GQL_RESPONSE["blogCategories_connection"]["nodes"];
  sort?: string;
  categoryName?: string;
}) {
  return (
    <div className="flex justify-between items-center py-5">
      <Select
        ...
        onValueChange={(e) => {
          if (e === "all") {
            ...
            window.location.href = `/blog/category/${e}`;
          }
        }}
      ...
      <Select
        ...
        onValueChange={(e) => {
          window.location.href = `/blog?sort=${e}`;
        }}
      >
